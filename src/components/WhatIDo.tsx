        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>AGENTIC AI</h3>
              <h4>Multi-Agent Systems & RAG</h4>
              <p>
                I build autonomous agent pipelines — from retrieval-augmented generation to multi-agent orchestration — that solve real problems under hackathon pressure and production constraints.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">LangChain</div>
                <div className="what-tags">LangGraph</div>
                <div className="what-tags">Agentic RAG</div>
